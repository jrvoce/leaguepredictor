...
namespace AustoPredictor.Data.Repositories;
...
public class PredictionRepository(IDbContextFactory<AustoPredictorDbContext> contextFactory) : IPredictionRepository
{
