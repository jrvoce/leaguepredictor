...
public class AustoPredictorDbContext(DbContextOptions<AustoPredictorDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PlayerPrediction>(entity =>
        {
            ...
            // A player can only predict each team's position once...
            entity.HasIndex(pp => new { pp.PlayerId, pp.TeamId }).IsUnique();
            // ...and can only use each position (1-10) once.
